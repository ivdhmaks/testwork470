...
(function (factory) {
  ...
  Plugin.prototype = {
    init: function init() {
      ...
      var iOS = navigator.userAgent.match(/(iPad|iPhone|iPod)/i) && !navigator.userAgent.match(/(WindowssPhone)/i) ? true : false;
      var Android = navigator.userAgent.match(/Android/i) && !navigator.userAgent.match(/(WindowssPhone)/i) ? true : false;
...
!function (i) {
  ...
  (e = function () {
    ...
    t && null !== t && (t = i(t).not(this.$slider)), null !== t && "object" == _typeof(t) && t.each(function () {
    ...
    var i = this,
        ...
        t = 0,
        o = 0;
    if (!0 === i.options.infinite) for (; e < i.slideCount;) {
      ++o, e = t + i.options.slidesToScroll, t += i.options.slidesToScroll <= i.options.slidesToShow ? i.options.slidesToScroll : i.options.slidesToShow;
    } else if (!0 === i.options.centerMode) o = i.slideCount;else for (; e < i.slideCount;) {
      ++o, e = t + i.options.slidesToScroll, t += i.options.slidesToScroll <= i.options.slidesToShow ? i.options.slidesToScroll : i.options.slidesToShow;
    }
    return o - 1;
    ...
    var s,
        n,
        l = this;
    if ("responsive" === e && "array" === i.type(t)) for (n in t) {
      if ("array" !== i.type(l.options.responsive)) l.options.responsive = [t[n]];else {
        for (s = l.options.responsive.length - 1; s >= 0;) {
          l.options.responsive[s].breakpoint === t[n].breakpoint && l.options.responsive.splice(s, 1), s--;
        }
...
$(function () {
  ...
  function scrollNav(el) {
    ...
    function setTopPadding() {
      ...
      body.style.paddingTop = "".concat(header_height, "px");
    } // setTopPadding();
  ...
  function getOffsetTop(el) {
    var $pos = jQuery(el).scrollTop();
    return $pos;
  }

  function showOnScroll($btn, $offset) {
    var $window_offset = getOffsetTop(window);
  ...
  function quantityCalc() {
    var $btn = jQuery('.js-quantity-btn');

    function activeReload(e) {
      var $reload_btn = e.closest('.quantity-box').siblings('.js-quantity-reload');
    ...
    $btn.on('click', function () {
      var $input = jQuery(this).siblings('.js-quantity'),
          $val = +$input.val(),
          $min,
          $step,
          res;
      ...
      if (jQuery(this).hasClass('minus') && $val > $min) {
        res = $val -= +$step; // activeReload(jQuery(this));
...
var handler = function handler() {
  ...
  var height_header = $('header').height(); //$('.content').css({'padding-bottom':height_footer+40, 'padding-top':height_header+40});
